...
wget https://github.com/exabrial/graylog-plugin-openwire/releases/download/graylog-plugin-openwire-1.3.1/graylog-plugin-openwire-1.3.1.jar.asc
wget https://github.com/exabrial/graylog-plugin-openwire/releases/download/graylog-plugin-openwire-1.3.1/graylog-plugin-openwire-1.3.1.jar
gpg --verify graylog-plugin-openwire-1.3.1.jar.asc graylog-plugin-openwire-1.3.1.jar
rm graylog-plugin-openwire-1.3.1.jar.asc
sudo mv graylog-plugin-openwire-1.3.1.jar /usr/share/graylog-server/plugin/
sudo chown root:root /usr/share/graylog-server/plugin/graylog-plugin-openwire-1.3.1.jar
